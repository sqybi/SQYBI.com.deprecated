...
“因为你不觉得很奇怪吗，只有那些成天念叨着梦想的人，才看不清现实啦。”""",
    ...
    (
        u"""努力是不会背叛自己的，虽然梦想有时会背叛。 努力不一定能实现梦想，但是曾经努力过的事实却足以安慰自己。""",
        u"《我的青春恋爱物语果然有问题》"
    ),
    (
    ...
    (
        u"""对于连最低限度的努力都不愿意的人。是没有资格羡慕有才能之人的。无法成功的人，就是因为他们想象不到成功者到底积聚了多少努力。""",
        u"《我的青春恋爱物语果然有问题》"
    ),
    (
        u"""“太阳快落下去了，你们的孩子居然不害怕？”<br/>
“当然不害怕，她知道明天太阳还会升起来的。”""",
        u"《三体II·黑暗森林》"
    ),
    (
...
在没有认识到这个显而易见的事实之前，人大概是无法走出社会的。""",
    ...
    (
        u"""没有人在遭受别人责难与训斥时，还能愉快起来，但我却从人们生气的怒容中看到比狮子、鳄鱼、巨龙更可怕的动物本性。<br/>
平时他们都将这些本性隐藏着，可一旦找到机会，就会像那些在草原上温文尔雅的牛，忽然甩动自己的尾巴抽死自己肚子上的牛虻。""",
    ...
    (
        u"""“我的生活很单调。我追逐鸡，人追逐我。所有的鸡都一个模样。所有的人也是。所以，我感到有点无聊。但是，如果你驯养了我，我的生活将充满阳光。我将辨别出一种与众不同的脚步声。别的脚步声会让我钻入地下，而你的脚步声却会像音乐一样，把我从洞穴里召唤出来。”<br/>
“我不吃面包，小麦对我来说毫无用处。麦田也不会让我联想到任何事。这是很可悲的！但是你长着金黄色头发。当你驯养我以后，这将是非常美妙的一件事！麦子的颜色也是金黄色的，它会让我想起你。而且我也将喜欢聆听风儿吹过麦田的声音……”""",
        u"《小王子》"
    ),
    (
    ...
    (
        u"""所有的大人都曾经是小孩，虽然只有少数的人记得。""",
        u"《小王子》"
    ),
    (
        u"""成人们对数字情有独钟。如果你为他们介绍一个朋友，他们从不会问你“他的嗓子怎么样？他爱玩什么游戏？他会采集蝴蝶标本吗？” 而是问“他几岁了？有多少个兄弟？体重多少？他的父亲挣多少钱？” 他们认为知道了这些，就了解了这个人。""",
        u"《小王子》"
    ),
    (
        u"""对别人抱有期待，只能让自己受伤。""",
